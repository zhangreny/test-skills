ER-1495 安全策略测试
    ...
    [拒绝-标签组] 重启OVS - A(0.0.0.0/0) B(0.0.0.0/0)
...
ER-1173 校验和测试
    ...
    分布式防火墙取消关联集群VDS - 校验和
    分布式防火墙关联集群VDS - 关机再开启
    分布式防火墙关联集群VDS - 重启集群各节点
发版升级路径测试
    3.1.1
        SmartX Everoute 2.0.4 -> 3.1.1 升级
        SmartX Everoute 3.0.0 -> 3.1.1 升级
        SmartX Everoute 3.1.0 -> 3.1.1 升级
        Arcfra ANS 3.1.0 -> 3.1.1 升级