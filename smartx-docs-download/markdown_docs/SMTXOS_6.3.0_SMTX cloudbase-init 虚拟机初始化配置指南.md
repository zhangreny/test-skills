---
title: "SMTXOS/6.3.0/SMTX cloudbase-init 虚拟机初始化配置指南"
source_url: "https://internal-docs.smartx.com/smtxos/6.3.0/cloudbase-init-guide/cloudbase-init-guide-preface-generic"
sections: 14
---

# SMTXOS/6.3.0/SMTX cloudbase-init 虚拟机初始化配置指南
## 关于本文档
