---
title: "SMTXOS/6.3.0/SMTX cloud-init 虚拟机初始化配置指南"
source_url: "https://internal-docs.smartx.com/smtxos/6.3.0/cloud-init-guide/cloud-init-guide-preface-generic"
sections: 17
---

# SMTXOS/6.3.0/SMTX cloud-init 虚拟机初始化配置指南
## 关于本文档
