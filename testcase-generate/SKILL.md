...
**Step 1：盘点输入文件 -> Step 2：先分析原始需求并让用户确认 -> Step 3：补齐相关 Drive 文档 -> Step 4：查询并摘要 Jira -> Step 5：整合资料并确认测试角度 -> Step 6：生成测试用例**
