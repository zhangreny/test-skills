...
- `case_seeds_round1.md`
- `case_seeds_round2.md`
- `case_seeds_round3.md`
- `case_seed_gap_report.md`
...
3. 仅补这些缺口，生成本轮 delta seeds：
   ...
   - 必删 seeds
   - 必调整 seeds
4. 将本轮 delta 合并进 working seeds，形成新的 `case_seeds_roundN.md`
...
只有在 `case_seeds_roundN.md` 满足停止条件后，才允许渲染最终 testcase markdown。
...
- `testcase_base.md` 中的每条 case 必须能回溯到一个或多个 seeds。
